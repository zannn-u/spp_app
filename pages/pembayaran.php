<?php require_once __DIR__."/../core/role_only.php"; $title="Pembayaran";
...
// UPDATE (ambil data untuk form edit)
if (isset($_GET['edit'])) {
    $id = intval($_GET['edit']);
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="#formTambahPembayaran" class="btn btn-primary btn-sm" onclick="document.getElementById('formTambahPembayaran').scrollIntoView();return false;"><i class="bi bi-plus-lg me-1"></i>Tambah Pembayaran</a>
  <?php endif; ?>
</div>
        ...
        <div class="row g-2">
          <div class="col-md-3">
            ...
            <select class="form-select" name="id_petugas" required>
              ...
              <?php $pet = mysqli_query($koneksi, "SELECT id_petugas, nama_petugas FROM petugas ORDER BY nama_petugas"); while($p = mysqli_fetch_assoc($pet)): ?>
          ...
          <div class="col-md-3">
            ...
            <select class="form-select" name="nisn" required>
              ...
              <?php $sis = mysqli_query($koneksi, "SELECT nisn, nama FROM siswa ORDER BY nama"); while($s = mysqli_fetch_assoc($sis)): ?>
          ...
          <div class="col-md-3">
            ...
            <select class="form-select" name="id_spp" required>
              ...
              <?php $spp = mysqli_query($koneksi, "SELECT id_spp, tahun, nominal FROM spp ORDER BY tahun DESC"); while($sp = mysqli_fetch_assoc($spp)): ?>
