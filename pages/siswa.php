<?php require_once __DIR__."/../core/role_only.php"; $title="Siswa";
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="#formTambahSiswa" class="btn btn-primary btn-sm" onclick="document.getElementById('formTambahSiswa').scrollIntoView();return false;"><i class="bi bi-plus-lg me-1"></i>Tambah Siswa</a>
      ...
      <div class="row g-2">
        ...
        <div class="col-md-3">
          ...
          <select class="form-select" name="id_kelas" required>
            ...
            <?php $kelas = mysqli_query($koneksi, "SELECT id_kelas, nama_kelas FROM kelas ORDER BY nama_kelas"); while($k = mysqli_fetch_assoc($kelas)): ?>
        ...
        <div class="col-md-4">
          ...
          <select class="form-select" name="id_spp" required>
            ...
            <?php $spp = mysqli_query($koneksi, "SELECT id_spp, tahun, nominal FROM spp ORDER BY tahun DESC"); while($s = mysqli_fetch_assoc($spp)): ?>
...
<div class="card shadow-sm">
  <div class="card-body">
    <table class="table table-striped datatable">
      <thead>
        <tr>
          <th>NISN</th><th>NIS</th><th>Nama</th><th>ID Kelas</th><th>Alamat</th><th>No Telp</th><th>ID SPP</th><th width="90">Aksi</th>
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-sm btn-outline-danger" href="/spp_app/index.php?page=siswa&hapus=<?= urlencode($d['nisn']) ?>" onclick="return confirm('Hapus data ini?')"><i class="bi bi-trash"></i></a>
          </td>
        </tr>
        <?php endwhile; ?>
      </tbody>
